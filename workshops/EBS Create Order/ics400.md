...
**2.3.5** In the *Basic Info* section of the _Configure Oracle E-Business Suite Adapter Endpoint_ wizard, give the endpoint a name of `EBS_Reference`.
(_Note - In the figure it says createEBSOrder. You can name the endpoint anything._)
...
**2.3.13** Observe that both the mapping and invocation to the EBS adapter now show up in the orchestration with the name `EBS_Reference`.  
